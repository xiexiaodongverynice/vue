        ...
        <!-- 表格 -->
         <el-table :data="tableData" stripe style="width: 100%" @selection-change="checkIds">
             <el-table-column type="selection" width="65" align="center"></el-table-column>
              ...
              <el-table-column  label="正常值范围"  align="center">
                  <div slot-scope="scope">
                      <span v-if="scope.row.zczxx&&scope.row.zczsx">{{scope.row.zczxx}}-{{scope.row.zczsx}}</span> 
                      <span v-if="scope.row.zczxx&&!scope.row.zczsx">>{{scope.row.zczxx}}</span>
                      <span v-if="!scope.row.zczxx&&scope.row.zczsx"><{{scope.row.zczsx}}</span> 
                       <span v-if="!scope.row.zczxx&&!scope.row.zczsx"></span> 
                  </div>
            </el-table-column>
      ...
      axios
        ...
        .then(
          axios.spread((data, memberGroup) => {
            ...
            console.log(this.memberGroup,"445")
