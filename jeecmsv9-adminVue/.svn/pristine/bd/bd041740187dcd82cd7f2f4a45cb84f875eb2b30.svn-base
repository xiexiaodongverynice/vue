...
const api={
    ...
    xinBoUpload:'/api/admin/ctsy/upload/o_upload',//文件上传
    xinBoDelImg:'/api/admin/ctsy/upload/delimg',//图片删除
  ...
  //数据库恢复
    ...
    getTargetlist:setAdminApi('zbk/getzbzblist'),//获取指标主表列表
    deleteZb:setAdminApi('zbk/deletezb'),//删除主表数据
    getZhibiaozb:setAdminApi('zbk/getzhibiaozb'),//查看主表数据
    saveZb:setAdminApi('zbk/savezb'),//添加主表
    updateZb:setAdminApi('zbk/updatezb'),//修改主表
    saveCb:setAdminApi('zbk/savecb'),//添加从表
    deleteCb:setAdminApi('zbk/deletecb'),//删除从表数据
    getZhibiaocb:setAdminApi('zbk/getzhibiaocb'),//查看从表数据
    updateCb:setAdminApi('zbk/updatecb'),//修改从表数据
    getcxGglist:setAdminApi('zbk/getcxjglist'),//机构查询下拉菜单
    gettJJglist:setAdminApi('zbk/gettjjglist'),//机构下拉菜单

    orgList: setAdminApi('test/querytokenxxlist'),//机构列表
    orgEdit: setAdminApi('test/updatetokenidxx'),//机构添加、修改
    orgUnpdate: setAdminApi('test/updatezttokenidxx'),//机构状态更新
    orgQueryOne: setAdminApi('test/queryOneToken'),//机构删除
    orgdel: setAdminApi('test/deltokenidxx'),//机构删除
    
    getzbfyxx: setAdminApi('zbk/getzbfyxx'),//指标信息


    jibingList: setAdminApi('zsjc/jibing/list'),//疾病列表
    jibingDetail: setAdminApi('zsjc/jibing/detail'),//疾病详情

    getKnowledgeList: setAdminApi('zsjc/common/getKnowledgeList'),//查询关联与备选知识列表
    updateDis: setAdminApi('zsjc/common/updateDis'),//保存划词内容
    updateStatus: setAdminApi('zsjc/common/updateStatus'),//保存校对状态
    updateContext: setAdminApi('zsjc/common/updateContext'),//保存校对状态
    getKnowledgeDetail: setAdminApi('/zsjc/common/getKnowledgeDetail'),//保存校对状态
    importxls: setAdminApi('/zbk/importxls'),//上传excel
    importxlstoFastDFS:setAdminApi('/zbk/importxlstoFastDFS'),
    //updateContext: setAdminApi('zsjc/common/updateContext'),//保存校对状态
    // getKnowledgeDetail: setAdminApi('zsjc/common/getKnowledgeDetail'),//查询识知详情


    yaoPinList: setAdminApi('zsjc/yaopin/list'),//药品列表
    yaoPinDetail: setAdminApi('zsjc/yaopin/detail'),//药品详情

    jianChaList: setAdminApi('zsjc/jiancha/list'),//检查列表
    jianChaDetail: setAdminApi('zsjc/jiancha/detail'),//检查详情

    jianYanList: setAdminApi('zsjc/jianyan/list'),//检验列表
    jianYanDetail: setAdminApi('zsjc/jianyan/detail'),//检验详情

    ssxxList: setAdminApi('zsjc/zyys/ssxx/list'),//中医膳食列表
    ssxxDetail: setAdminApi('zsjc/zyys/ssxx/detail'),//中医膳食详情

    xwpxList: setAdminApi('zsjc/zyys/xwpx/list'),//中医穴位列表
    xwpxDetail: setAdminApi('zsjc/zyys/xwpx/detail'),//中医穴位详情

    fyjkList: setAdminApi('zsjc/fyjk/list'),//妇幼健康列表
    fyjkDetail: setAdminApi('zsjc/fyjk/detail'),//妇幼健康详情
    updateEsData: setAdminApi('/zsjc/common/updateEsData')//更新搜索引擎数据
}
