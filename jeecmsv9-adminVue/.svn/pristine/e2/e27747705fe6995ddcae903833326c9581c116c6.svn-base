...
export const ansycRoutes = [
    ...
    },
    {
        ...
        children: [{
            ...
            children: [{
              ...
              {
                path: '/target/attachedadd', //指标从表添加
                name: '指标从表添加',
                component: resolve => { require(['@/views/data/target/attachedadd.vue'], resolve) },
                hidden: true
              },
              {
                path: '/target/attachededit', //指标从表添加
                name: '指标从表修改',
                component: resolve => { require(['@/views/data/target/attachededit.vue'], resolve) },
                hidden: true
              },
              {
                path: '/target/attachedview', //指标从表添加
                name: '指标从表修改',
                component: resolve => { require(['@/views/data/target/attachedview.vue'], resolve) },
                hidden: true
              } 
            ]
          }]
    },
    {
        ...
        } ,
        {
            ...
            component: childView,
            isParent: true,
            redirect: '/yaoPin/list',
            children: [{
                    path: '/yaoPin/list', //机构列表
                    name: '药品列表',
                    component: resolve => { require(['@/views/zhiShiJC/yaoPin/list.vue'], resolve) },
                },
                {
                    path: '/yaoPin/oprate', //机构添加
                    name: '药品划词',
                    component: resolve => { require(['@/views/zhiShiJC/yaoPin/oprate.vue'], resolve) },
                }
            ]
        },
        {
            ...
            component: childView,
            isParent: true,
            redirect: '/jianCha/list',
            children: [{
                    path: '/jianCha/list', //机构列表
                    name: '检查列表',
                    component: resolve => { require(['@/views/zhiShiJC/jianCha/list.vue'], resolve) },
                },
                {
                    path: '/jianCha/oprate', //机构添加
                    name: '检查划词',
                    component: resolve => { require(['@/views/zhiShiJC/jianCha/oprate.vue'], resolve) },
                }
            ]
        },
        {
            ...
            component: childView,
            isParent: true,
            redirect: '/jianYan/list',
            children: [{
                    path: '/jianYan/list', //机构列表
                    name: '检验列表',
                    component: resolve => { require(['@/views/zhiShiJC/jianYan/list.vue'], resolve) },
                },
                {
                    path: '/jianYan/oprate', //机构添加
                    name: '检验划词',
                    component: resolve => { require(['@/views/zhiShiJC/jianYan/oprate.vue'], resolve) },
                }
            ]
        },
        {
            ...
            children: [{
                    path: '/ssxx/list', 
                    name: '膳食列表',
                    component: resolve => { require(['@/views/zhiShiJC/ssxx/list.vue'], resolve) },
                },
                {
                    path: '/ssxx/oprate', 
                    name: '膳食划词',
                    component: resolve => { require(['@/views/zhiShiJC/ssxx/oprate.vue'], resolve) },
                }
            ]
        },
        {
            ...
            children: [{
                    path: '/xwpx/list', 
                    name: '穴位列表',
                    component: resolve => { require(['@/views/zhiShiJC/xwpx/list.vue'], resolve) },
                },
                {
                    path: '/xwpx/oprate', 
                    name: '穴位划词',
                    component: resolve => { require(['@/views/zhiShiJC/xwpx/oprate.vue'], resolve) },
                }
            ]
        },
        {
            ...
            children: [{
                    path: '/fyjk/list', 
                    name: '妇幼健康列表',
                    component: resolve => { require(['@/views/zhiShiJC/fyjk/list.vue'], resolve) },
                },
                {
                    path: '/fyjk/oprate', 
                    name: '妇幼健康划词',
                    component: resolve => { require(['@/views/zhiShiJC/fyjk/oprate.vue'], resolve) },
                }
            ]
        }
        ]
